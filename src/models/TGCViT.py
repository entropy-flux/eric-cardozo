...
class Perceptron(Module):
    def __init__(
        ...
        self.beta = Parameter(ones(1, 1, 1))
    ...
    def forward(self, features: Tensor) -> Tensor:
        ...
        features = sigmoid(self.beta * (q-self.mu)) * tanh(q) * v
...
class Attention(Module): 
    def __init__(
        ...
        self.beta = Parameter(ones(1, 1, 1, 1))
    ...
    def forward(self, sequence: Tensor) -> Tensor:
        ...
        scores = sigmoid(self.beta*(scores-self.mu)) * exp(scores) 
...
class GrandCanonicalTermalViT(Module):  
    def __init__(
        self,  
